...
function App() {
  ...
  return (
    ...
    >
      ...
      <div
        className="fixed top-0 left-0 z-10 w-full overflow-hidden"
      ...
      >
        ...
        >
          <h1 className="text-7xl text-black dark:text-white">cha</h1>
        </div>
      </div>

      <div
        className="fixed bottom-0 left-0 z-10 w-full overflow-hidden"
        style={{ height: `${topHeight}px` }}
      >
        <div
        ...
        <div
          ...
          style={{ transform: `translateY(${shift}px)` }}
        >
          <h1 className="text-7xl text-black dark:text-white">krupka</h1>
        </div>
      </div>
    </div>
  );
